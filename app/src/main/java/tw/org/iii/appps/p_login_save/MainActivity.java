    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_logIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //2.從資料庫取得資料
                String userDetails = mPreferences.getString(user + pwd +"data", "帳密錯誤" );//取得資料庫資料(1.資料目錄名 2.錯誤訊息);
                mPreferences.edit()//edit物件實體
                        .putString("display",userDetails)
                        .commit();

                Log.v("hank","userDetails:" + userDetails);
                Intent displayIntent = new Intent(MainActivity.this,displayInfoActivity.class);
